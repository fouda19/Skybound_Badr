...
namespace our {
    ...
    public:
        ...
        Texture2D() {
            ...
            glGenTextures(1 , &name); //generate single texture store it in GLunit variable name
        ...
        static void unbind(){
            //TODO: (Req 5) Complete this function
            glBindTexture(GL_TEXTURE_2D , 0); //bind with zero to make sure no texture is bound
        }
